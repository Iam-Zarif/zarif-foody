      ...
      <div>
        ...
        <div className="mt-10">
         ...
         <hr className='mt-5 w-96 mx-auto' />
          ...
          <p className ="px-5">
            ans : In the context of software engineering, uncontrolled
            ...
            application and are instead managed by the browser's DOM. On the
            ...
            of these elements are reflected in the application's state. The main
            ...
            with legacy code or when performance is a critical concern.
          </p>
          ...
          <p className ="px-5">
            ...
            documentation for the component's expected props. If the component
            ...
            used correctly and to catch errors early in the development process.
          </p>
          ...
          <p className ="px-5">
            ...
            as handling HTTP requests and responses, routing, and middleware.
          </p>
